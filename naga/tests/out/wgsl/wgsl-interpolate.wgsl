struct FragmentInput {
    ...
    @location(0) @interpolate(flat) @align(16) _flat: u32,
    ...
    @location(4) @interpolate(linear, centroid) @align(32) linear_centroid: vec2<f32>,
    @location(6) @interpolate(linear, sample) @align(16) linear_sample: vec3<f32>,
    @location(7) @interpolate(linear) @align(64) linear_center: vec3<f32>,
    @location(8) @align(16) perspective: vec4<f32>,
    @location(9) @interpolate(perspective, centroid) @align(32) perspective_centroid: f32,
